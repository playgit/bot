...
// ENDGAME: earlier trigger (20s) for more center camping time
var endgame=(r.remaining<20);
...
if(!endgame){
  ...
  // ENGAGE with center-pull + slightly wider aim
  if(enemy){
    ...
    var tgtWidth=Math.atan2(32,range);
    var since=m.t-m.lf;
  ...
  // ENDGAME: Pure center rush, fire opportunistically
  if(dCenter>20){
    a.desiredAngle=toCenter;
    a.desiredForce=s.maxForce;
  }else{
