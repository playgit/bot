...
if(!m.t){m.t=0;m.lf=-99;m.ev=1;m.dir=1;m.fired=0;}
m.t++;
...
// === FROM L3: Multi-projectile dodge - find most dangerous projectile ===
var eProj=false;
var worstThreat=0;
...
if(dCenter>160){
  ...
  // FROM L1: Scan cycling when idle
  if(!enemy){
