...
if(!endgame){
  ...
  if(enemy){
    ...
    var projSpeed=55;var tF=range/projSpeed;
  ...
  // === MUTATION: No dodge during final stand — pure center park ===
  // Just rush center, stop rotating, ignore projectiles
  if(dCenter>10){
    a.desiredAngle=toCenter;a.desiredForce=s.maxForce;
  }else{
    a.desiredAngle=false;a.desiredForce=0;
  }
}
