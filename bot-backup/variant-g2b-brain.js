...
// === MUTATION: Focus fire — prefer memorized target if still visible ===
var enemy=false;
var bestEDist=9999;
...
// Stick with memorized target if still visible and within reasonable range
if(memorizedTarget&&memorizedTarget.range<350){
  enemy=memorizedTarget;
}
