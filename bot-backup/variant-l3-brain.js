...
// === MUTATION: Enemy count awareness ===
var fewEnemies=(r.active<=3);
...
if(!endgame){
  ...
  // === MUTATION: When few enemies remain, go pure defensive (center camp) ===
  if(fewEnemies&&dCenter<60){
    // Don't pursue enemies, just hold center and fire opportunistically
    if(enemy){
      ...
      // Always pull to center, never advance
      if(dCenter>20){
