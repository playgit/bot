...
// === MUTATION: Velocity-aware center braking ===
// Use current velocity direction to decide braking vs thrusting
var velAngle=s.angle;  // approximate velocity direction from facing angle
...
if(dCenter>160){
  ...
  // === MUTATION: Brake harder when moving away from center ===
  if(velToCenter<-0.3){
  ...
  // === MUTATION: Counter-drift when near center ===
