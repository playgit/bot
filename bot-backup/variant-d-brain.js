...
// ENDGAME MODE: In final 15 seconds, rush to center and ignore combat
...
if(!endgame){
  ...
  // ENDGAME: Pure center rush, still fire opportunistically
  if(dCenter>20){
    a.desiredAngle=toCenter;
    a.desiredForce=s.maxForce;
  }else{
  ...
  a.desiredScan=150;
  // Fire if already aimed at enemy
  if(enemy){
